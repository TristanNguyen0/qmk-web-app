...
- [x] 05-02-PLAN.md — One curated smoke-matrix runner over toolchain-diverse fixture sets (wave 2)
- [x] 05-03-PLAN.md — Anonymous-only launch identity: persistent data-loss notice, export/import, ADR 0006 (wave 2)
- [x] 05-04-PLAN.md — Retention ledger, Postgres backups with a real restore drill, licensing review (wave 2)
- [x] 05-05-PLAN.md — Session issuance IP limit, required session secret, explicit trusted proxy hop (wave 2)
...
| 5. Hardening and Scale | 5/8 | In Progress|  |
