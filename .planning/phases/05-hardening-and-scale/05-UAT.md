...
number: 1
name: OTLP metrics reach a live collector
expected: |
  All four signals arrive at the collector with correct instrument names, closed-enum
  attribute values, and no free-text, IP, or filesystem-path content in any attribute.
